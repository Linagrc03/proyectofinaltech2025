...
specified_countries_data = df[df['Entity'].isin(paises_suramericanos)]

produccion_total_paises = specified_countries_data.groupby('Entity')['Electricity from hydro (TWh)'].sum().sort_values(ascending=False)
